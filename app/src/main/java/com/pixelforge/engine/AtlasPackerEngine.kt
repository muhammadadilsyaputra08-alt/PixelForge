...
object AtlasPackerEngine {
    ...
    fun pack(
        ...
        return AtlasModel(
            ...
            height = binH,
            padding = padding,
            // BUGFIX: persist the spacing actually used for this pack, so the panel's stepper
            // keeps showing (and every later repack keeps honoring) what the user picked instead
            // of silently reverting to 1 - see AtlasModel.spacing's doc.
